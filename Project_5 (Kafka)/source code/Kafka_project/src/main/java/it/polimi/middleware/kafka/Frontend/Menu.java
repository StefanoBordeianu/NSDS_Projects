...
public class Menu {
    ...
    public static void runCLI(UserService userService, CourseService courseService, ProjectService projectService) {
        Menu.userService = userService;
        Menu.courseService = courseService;
        Menu.projectService = projectService;
    ...
    private static void loginUser() throws Exception {
        ...
        if (jsonResponse.getString("status").equals("success")) {
            ...
            String role = extractRoleFromToken(token); // Implement this function to decode the
    ...
    private static String extractRoleFromToken(String token) {
        ...
        return userService.getUser(userId).getRole();
    }
}
